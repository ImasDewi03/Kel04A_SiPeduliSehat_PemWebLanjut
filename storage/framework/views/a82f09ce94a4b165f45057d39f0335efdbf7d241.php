				...
				<div class="row row-sm">
					...
					<div class="col-xl-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="spesialis" required class="form-control" id="spesialis" value="<?php echo e(old('spesialis')); ?>">
                        </div>
                        <div class="mb-3">
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pemweb\L-sirs\resources\views/admin/tambah_dokter.blade.php ENDPATH**/ ?>