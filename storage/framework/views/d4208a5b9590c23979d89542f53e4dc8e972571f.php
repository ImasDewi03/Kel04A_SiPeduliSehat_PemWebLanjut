...
<?php $__env->startSection('title', 'Jadwal Praktek'); ?>
            ...
            <div class="container-fluid mg-t-20">
				...
				<div class="row row-sm">
					...
					<div class="col-xl-12">
						...
						?>			
						<?php $__currentLoopData = $jadwal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>					<tr>
                            ...
                            <a href="/edit_jadwal/<?php echo e($j->id); ?>"><i class="fas fa-pencil-alt" style="margin-right:5px"></i></a>
                            <form action="/hapus_jadwal" method="post" class="d-inline">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" value="<?php echo e($j->id); ?>" name="id">
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pemweb\L-sirs\resources\views/admin/jadwal_praktek.blade.php ENDPATH**/ ?>