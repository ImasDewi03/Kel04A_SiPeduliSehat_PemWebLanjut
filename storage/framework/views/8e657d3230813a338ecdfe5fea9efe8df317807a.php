							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img src="/gambar/profil.png">
									<div class="p-text d-none">
										<span class="p-name font-weight-bold"><?php echo e(session('username')); ?></span>
								...
								<div class="dropdown-menu shadow">
									<div class="main-header-profile header-img">
										...
										<h6><?php echo e(session('username')); ?></h6><span>Administrator</span>
									</div>
							...
							<div class="card-body text-center">
								<div class="dropdown user-pro-body">
									...
									<div class="user-info mg-t-20">
										<h6 class="font-weight-semibold  mt-2 mb-0"><?php echo e(session('username')); ?></h6>
...
</html><?php /**PATH C:\xampp\htdocs\SiPeduliSehat\resources\views/layout/layout.blade.php ENDPATH**/ ?>